<template>
    <div style="margin: 1.5%;">
      ...
      <v-row>
        <v-col cols="12">
          <v-card>
            <v-table density="compact" class="table-container">
              <thead>
                <tr style="height: 47px">
                  ...
                  <th class="text-center text-uppercase text-medium-emphasis d-flex align-center justify-center" style="position: absolute;right: 0;margin-top: 7px;z-index: 100;">
                    <p class="mb-2">Hành động</p>
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr v-if="users.length > 0" v-for="i in users" :key="i" style="height: 58px;">
                  ...
                  <td></td>
                  <td class="text-center d-flex align-center justify-center" style="position: absolute;z-index: 10000;right: 0;height: 58px;background: white;">
